<?php if (!empty($success)): ?>
	<div class="alert alert-success">
	  <strong>Exitoso!</strong> Transferencia hecha con exito.
	</div>
<?php endif ?>
<h4>Transferencia</h4>

<form action="./index.php?action=transferir" method="post">
	<div class="container">
...
<button id="transferir" class="btn btn-success">Transferir</button>
